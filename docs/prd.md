...
> - 2차: MKT-009, PORT-003, LMT-001~005, NOTI-001~005, JOUR-001~006, RANK-001~002 (3단계 투자 실습 EDU-PRACTICE-*와 AI 피드백 FEED-*는 이 문서에 요구사항 절을 두지 않고 각각 `docs/specs/016-investment-education-policy`·`docs/specs/012-ai-feedback`이 정본이다)
