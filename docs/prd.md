...
- 알림
- 지정가 주문과 배치 체결
- 매수 체결 기준 투자일기 작성, 수정·목록·상세와 매도 회고 (2026-07-28 Notion 확인 — 작성도 2차로 이동)
...
> PORT-004(매수 투자일기 작성)는 2026-07-28 Notion 확인 결과 1차 MVP가 아니라 2차(1차 고도화) 범위다. 상세 요구사항 초안은 `docs/specs/007-journal/spec.md`에 남겨두고 이 문서의 1차 요구사항에서는 제외한다.
