...
| 투자일기 — 상세 조회 | JOUR-005 | **문서 확정** | 이슈 [#217](https://github.com/finplay-team/finplay/issues/217)에서 타입별 경로 분리로 계약 확정(`007-journal` spec·plan·tasks). production 미착수 — `JournalDetailController` 없음 |
