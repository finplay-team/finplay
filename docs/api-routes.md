...
| PUT | /api/education/practice/attempts/{market} | education | 사용자·시장별 attempt를 없을 때만 생성하고 기존 실행 세대·종목·위험 스냅샷을 변경 없이 반환. 완료 attempt는 읽기 전용 `REPLAY` | 036 TUTORIAL-FLOW-001·002·005, Issue #378 |
...
| GET | /api/education/practice/attempts/{market}/chart | education | 현재 attempt seed·version·anchor로 재현한 29개 완결 일봉과 가상 12:00부터 공개된 현재 일봉을 side effect 없이 순수 조회. 3초마다 가상 1분 진행하며 마지막 close가 canonical 가격 | 036 TUTORIAL-FLOW-009·010·011·012, Issue #378 |
