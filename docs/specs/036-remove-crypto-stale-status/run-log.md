...
| - | implementer | `./gradlew build` | spec.md 완료 조건(003·032·034 각주/재작성, prd.md §3 갱신), CLAUDE.md 규칙 10 |
...
- 항목 4 완료 — 003 MKT-004 STALE 노출 문구를 "경과 시간과 무관하게 항상 AVAILABLE"로 본문 재작성, 032·034 spec.md 최상단에 036 대체 각주 추가(체크박스 원문 유지), prd.md §3 PRICE-STALE·PRICE-REST 행 갱신 + PRICE-NOSTALE-001~004 신규 행 추가. `./gradlew build` 통과(Spotless·SpotBugs·커버리지 게이트 포함).
