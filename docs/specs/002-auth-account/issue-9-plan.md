...
- service가 provider 해석, state 생성, 활성 provider 선택과 URI 생성을 조합하고 `OAuthAuthorizationResult(OAuthProviderName provider, URI authorizationUri, String state)`를 반환한다.
