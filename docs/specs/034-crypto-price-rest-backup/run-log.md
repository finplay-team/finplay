...
| 시각 | 에이전트 | 실행 명령 | 근거 |
|---|---|---|---|
| 리뷰 | reviewer | `git diff dev...HEAD --stat`, `git diff dev...HEAD -- <각 파일>`, `./gradlew compileJava compileTestJava -q` | docs/conventions.md, docs/adr/0002·0003·0004, spec.md·plan.md·tasks.md(034), docs/specs/003-market-data/spec.md, docs/specs/032-price-quote-stale-split/spec.md, docs/api-contracts.md, docs/prd.md |
