...
- [x] **2. 파생 사실 — 보유 구간 극값·뉴스 대비 타이밍·보유 구간 카드**
...
- [x] **3. 매도 후 흐름·반사실 가격과 시각 게이트 — 7번이 끼울 자리 남기기**
...
- [x] **4. AI 서술 — 최초 조회 생성·저장·재사용과 템플릿 폴백**
...
- [x] **5. 서술 재생성 — 재생성 게이트 통과 후 1회와 누적 재시도 상한**
...
- [x] **6. 문서 동기화 — `api-routes.md`·`api-contracts.md` 대조**
