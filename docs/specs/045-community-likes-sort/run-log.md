...
| - | reviewer | `git log --oneline 74d2f4f4..HEAD`·`git diff 74d2f4f4..HEAD`·`gh pr checks 442`(3개 커밋 범위 리뷰) | docs/conventions.md, ADR-0002·0003·0004, CLAUDE.md 규칙 7·9·10, docs/agent-mistakes.md 2026-08-17 행(잠금 전 조회로 인한 1급 캐시 오염), docs/api-contracts.md |
