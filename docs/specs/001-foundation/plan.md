...
- ErrorCode enum은 PRD §5 공통 오류표 전체를 포함한다 — VALIDATION_ERROR·EMAIL_VERIFICATION_FAILED·OAUTH_EMAIL_REQUIRED(400), UNAUTHORIZED(401), FORBIDDEN(403), NOT_FOUND(404), DUPLICATE_RESOURCE·EMAIL_VERIFICATION_REQUIRED·ACCOUNT_LINK_REQUIRED·INSUFFICIENT_CASH·INSUFFICIENT_QTY·MARKET_CLOSED·PRICE_UNAVAILABLE·IDEMPOTENCY_CONFLICT(409), UNSUPPORTED_ORDER_TYPE(422), TOO_MANY_REQUESTS(429).
