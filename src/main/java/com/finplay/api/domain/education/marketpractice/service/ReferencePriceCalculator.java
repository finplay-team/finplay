 ...
 * production 구현 미착수" 상태다(spec.md 1행) — 실제 {@link com.finplay.api.domain.education.model.PracticeIntention}
 * 레코드와 {@link com.finplay.api.domain.education.dto.request.PracticeIntentionCreateRequest}는 {@code exitPriceType}·
...
public class ReferencePriceCalculator {
	 ...
	 * {@link com.finplay.api.domain.order.service.ExitPricePolicy}의 PERCENT 경로는 체결가를 <b>정규화하지 않고</b>
